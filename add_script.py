...
for i in range(60,len(names)):
	...
	cmd_ = cmd.format(id,fname,lname,phno,dob,salary,acc_num)
	f.write(cmd_)

cmd = "INSERT INTO department VALUES('{}','{}',{});\n"
f.write(cmd.format('Food','Kitchen',1))
f.write(cmd.format('Help','Housekeeping',2))
f.write(cmd.format('Security','Security',3))
f.write(cmd.format('Accounts','Accounts',4))
f.write(cmd.format('Inventory','Inventory',5))
